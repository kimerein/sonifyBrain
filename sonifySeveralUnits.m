function [output_data,out_Fs]=sonifySeveralUnits(psth,unitInds,useTrials,params,outputFileName,mappingType,bursts)

output_data=[];
for i=1:length(unitInds)
    unitInd=unitInds(i);
    [output,out_Fs]=sonifySingleUnit(psth,unitInd,useTrials,params,mappingType,bursts);
...
function [output_data,out_Fs]=sonifySingleUnit(psth,unitInd,useTrials,params,mappingType,bursts)
